/*
  Follow Me Robot - Assistant Robot that Follows Human
  RFID-based human-following robot with ultrasonic obstacle avoidance.
...
byte validUID[] = {0xA9, 0xEC, 0xF4, 0xB8};
